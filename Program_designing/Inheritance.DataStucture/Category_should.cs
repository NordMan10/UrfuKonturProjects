...
namespace Inheritance.DataStructure
{
    ...
    public class Category_should
    {
        ...
        //Category categoryWithNullName = new Category(null, 0, 0);
        //Category nullCategory = null;
        //[Test]
        //public void NullsEqualCompare()
        //{
        //    Assert.AreEqual(nullCategory, null);
        //    Assert.IsTrue(nullCategory == null);
        //    Assert.IsTrue(nullCategory <= null);
        //    Assert.IsTrue(nullCategory >= null);
        //    Assert.Zero(categoryWithNullName.CompareTo(A11));
        //    Assert.Zero(categoryWithNullName.CompareTo(nullCategory));
        //}
    }
}
